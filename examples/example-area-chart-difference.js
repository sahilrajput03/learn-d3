// src: https://observablehq.com/@d3/difference-chart
const data = [
	{date: new Date('2011-10-01'), 'New York': 63.4, 'San Francisco': 62.7},
	{date: new Date('2011-10-02'), 'New York': 58, 'San Francisco': 59.9},
	{date: new Date('2011-10-03'), 'New York': 53.3, 'San Francisco': 59.1},
	{date: new Date('2011-10-04'), 'New York': 55.7, 'San Francisco': 58.8},
	{date: new Date('2011-10-05'), 'New York': 64.2, 'San Francisco': 58.7},
	{date: new Date('2011-10-06'), 'New York': 58.8, 'San Francisco': 57},
]
chart = DifferenceChart(data, {
	x: (d) => d.date, // requires date object
	y1: (d) => d['New York'], // requires number
	y2: (d) => d['San Francisco'], // requires 
